...
public class GetProductsQueryHandlerTest
{
    ...
    public GetProductsQueryHandlerTest()
    {
        ...
        _mapperMock = new();
        _getProductsQueryHandler = new GetProductsQueryHandler(_productRepositoryMock.Object, _mapperMock.Object);
    }
    ...
    public async Task Handle_Should_ReturnSuccessResult_WithSearchResponse_WhenProductsExist()
    {
        ...
        var products = new List<Product>
            {
                Product.Create(new CreateProductRequest("Code", 123, "Size", "Description", "Name", null), "CreatedBy"),
                Product.Create(new CreateProductRequest("Code", 123, "Size", "Description", "Name", null), "CreatedBy"),
            };
