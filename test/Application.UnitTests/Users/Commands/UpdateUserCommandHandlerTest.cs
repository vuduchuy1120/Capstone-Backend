...
public class UpdateUserCommandHandlerTest
{
    ...
    private readonly Mock<ISalaryHistoryRepository> _salaryHistoryRepositoryMock;
    ...
    public UpdateUserCommandHandlerTest()
    {
        ...
        _salaryHistoryRepositoryMock = new();
    ...
    public async Task Handler_ShouldThrow_MyValidationException_WhenUserIdNotExist()
    {
        var updateUserRequest = new UpdateUserRequest("001201011091", "FirstName", "LastName", 
            "0976099351", "image", "Hanoi", "Male", "10/03/2001",
            SalaryByDayRequest: new SalaryByDayRequest(150, "10/03/2001"),
            SalaryOverTimeRequest: new SalaryOverTimeRequest(200, "10/03/2001"), Guid.NewGuid(), 1);
        ...
        var updateUserCommandHandler = new UpdateUserCommandHandler(
            ...
            _salaryHistoryRepositoryMock.Object,
    ...
    "Male", "10/03/2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //firstName contains number or specification character is not valid
    [InlineData("001201011091", "", "Doe", "0976099351", "123 Main St, Anytown, USA",
    "Male", "10/03/2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //firstName empty is not valid
    [InlineData("001201011091", "John", "Doe1112", "0976099351", "123 Main St, Anytown, USA",
    "Male", "10/03/2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //lastName contains number or specification character is not valid
    [InlineData("001201011091", "John", "", "0976099351", "123 Main St, Anytown, USA",
    "Male", "10/03/2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //lastName empty is not valid
    [InlineData("001201011091", "John", "Doe", "0sdfsd976099351", "123 Main St, Anytown, USA",
    "Male", "10/03/2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //phone contains characters is not valid
    [InlineData("001201011091", "John", "Doe", "", "123 Main St, Anytown, USA",
    "Male", "10/03/2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //phone is empty is not valid
    [InlineData("001201011091", "John", "Doe", "0976099351", "123 Main St, Anytown, USA",
    "Male", "10/03/2001", -150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //salaryByDay less than 0 is not valid
    [InlineData("001201011091", "John", "Doe", "0976099351", "123 Main St, Anytown, USA",
    "", "10/03/2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //gender empty is not valid
    [InlineData("001201011091", "John", "Doe", "0976099351", "123 Main St, Anytown, USA",
    "dfd", "10/03/2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //gender difference "Male" or "Female" is not valid
    [InlineData("001201011091", "John", "Doe", "0976099351", "123 Main St, Anytown, USA",
    "Male", "", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //date empty is not valid
    [InlineData("001201011091", "John", "Doe", "0976099351", "123 Main St, Anytown, USA",
    "Male", "10-03-2001", 150.00, "10/03/2001", 200.00, "10/03/2001", 2)] //date wrong format dd/MM/yyyy is not valid
    ...
    string gender, string dob, decimal salaryByDay, string salaryByDayDate, decimal salaryOverTime, string salaryOverTimeDate, int roleId)
    {
        var salaryByDayRequest = new SalaryByDayRequest(salaryByDay, salaryByDayDate);
        var salaryOverTimeRequest = new SalaryOverTimeRequest(salaryOverTime, salaryOverTimeDate);
        var updateUserRequest = new UpdateUserRequest(id, firstName, lastName, phone, "image", address,
            gender, dob, salaryByDayRequest, salaryOverTimeRequest, Guid.NewGuid(), roleId);
        var updateUserCommand = new UpdateUserCommand(updateUserRequest, "UpdateBy");
        var updateUserCommandHandler = new UpdateUserCommandHandler(
            _userRepositoryMock.Object, 
            _salaryHistoryRepositoryMock.Object,
    ...
    public async Task Handler_ShouldThrow_UserNotFoundException_WhenUserNotFound()
    {
        var updateUserRequest = new UpdateUserRequest(
            ...
            Guid.NewGuid(), 1);
        var updateUserCommand = new UpdateUserCommand(updateUserRequest, "UpdateBy");
        var updateUserCommandHandler = new UpdateUserCommandHandler(_userRepositoryMock.Object,_salaryHistoryRepositoryMock.Object , _unitOfWorkMock.Object, _validator);
    ...
    {
        var updateUserRequest = new UpdateUserRequest("001201011091", "FirstName", "LastName",
            "0976099351", "image", "Hanoi", "Male", "10/03/2001", SalaryByDayRequest: new SalaryByDayRequest(150, "10/03/2001"),
            SalaryOverTimeRequest: new SalaryOverTimeRequest(200, "10/03/2001"), Guid.NewGuid(), 1);
        var updateUserCommand = new UpdateUserCommand(updateUserRequest, "UpdateBy");
        var updateUserCommandHandler = new UpdateUserCommandHandler(
            _userRepositoryMock.Object, 
